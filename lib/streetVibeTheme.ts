...
export const OUTPUT_PREMIUM_OPTIONS: { value: string; label: string }[] = [
  ...
  { value: "Lisbon Street", label: "💎 Lisbon" },
  { value: "Berlin Street", label: "💎 Berlin" },
  { value: "Madrid Barrio", label: "💎 Madrid" },
  { value: "Rome Street", label: "💎 Rome" },
  { value: "Mexico City Barrio", label: "💎 Mexico City" },
...
export const OUTPUT_STANDARD_OPTIONS: { value: string; label: string }[] = [
  { value: "English (Standard)", label: "🇺🇸 USA" },
  ...
  { value: "Arabic", label: "🇸🇦 Arabia" },
  { value: "Hebrew (Standard)", label: "🇮🇱 Israel" },
];
