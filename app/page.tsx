      ...
      >
        ...
        <div className="flex flex-col items-center py-2">
          <button
            ...
            className={`flex h-28 w-28 shrink-0 items-center justify-center overflow-hidden rounded-full shadow-xl transition-all duration-500 ease-in-out active:scale-95 ${
          ...
          >
            <MicBallContent micBall={micBall} isListening={isListening} iconClassName="h-14 w-14" />
          </button>
          <span
